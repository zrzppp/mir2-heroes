...
var
  g_sGameRemoteAddress: string = 'Q4qzFQMQX91zQsKYCZLHHlAa+hT9ZCqMvbWvBdEfXihx0c1fRyUSghmT9sn7';
  ...
  g_sLoginServer_ChrLogDir: string = 'ChrLogDir\';
  ...
  g_boGetM2ServerVersion: Boolean = False;
  g_nServerVersion: Integer = -1;
  g_nUpDateVersion: Integer = -1;
