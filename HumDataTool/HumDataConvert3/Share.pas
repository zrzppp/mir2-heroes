...
const
  ...
  g_sFileNames: array[0..6] of string = ('ID.db', 'Hum.db', 'Mir.db', 'UserStorage.db', 'UserSellOff.sell', 'UserSellOff.Gold', 'Duel.Item');
  g_sFilters: array[0..6] of string = ('ID.db|*.db', 'Hum.db|*.db', 'Mir.db|*.db', 'UserStorage.db|*.db', 'UserSellOff.sell|*.sell', 'UserSellOff.Gold|*.Gold', 'Duel.Item|*.Item');
var
  g_boClose: Boolean;

  g_boConverts: array[0..6] of Boolean = (True, True, True, True, True, True, True);
  g_sSourceFiles: array[0..6] of string;

  g_boID: Boolean = True;
  g_boHum: Boolean = True;
  g_boMir: Boolean = True;
  g_boBigStorage: Boolean = True;
  g_boSellOff: Boolean = True;
  g_boGoldOff: Boolean = True;
  g_boDuel: Boolean = True;
  ...
  g_ButtonEdit: array[0..6] of TRzButtonEdit;
implementation
