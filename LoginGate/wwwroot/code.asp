...
'=========================================================
' Tingt 彩色验证码
' Copyright (C) 2006 863sf.cn All rights reserved.
' URL: http://www.863sf.cn
'=========================================================
...
codebg = ChrB(255) & ChrB(255) & ChrB(255) ' 蓝255，绿255，红255（验证码背景色：黄色）

' 字符颜色
Dim tc(3)
tc(0) = ChrB(Rnd * 255) & ChrB(Rnd * 128) & ChrB(Rnd * 255)
tc(1) = ChrB(Rnd * 255) & ChrB(Rnd * 128) & ChrB(Rnd * 255)
tc(2) = ChrB(Rnd * 255) & ChrB(Rnd * 128) & ChrB(Rnd * 255)
tc(3) = ChrB(Rnd * 255) & ChrB(Rnd * 128) & ChrB(Rnd * 255)
  ...
  For ii = 0 To 3  ' 历经所有字
   For iii = 1 To 10 ' 历经所有像素
    ...
    If Rnd * 99 + 1 < cOdds Then ' 随机生成杂点
     Response.BinaryWrite tc(ii)
    Else
     if cint(Mid(vNumberData(vCode(ii)), i * 10 + iii, 1)) = 0 then
      Response.BinaryWrite tc(ii)
     else
     	Response.BinaryWrite codebg
     end if
    End If
   Next
  Next
