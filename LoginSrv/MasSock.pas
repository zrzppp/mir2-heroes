...
begin
  ...
  if boAllowed then begin
    ...
    //MainOutMessage('地址连接:' + sRemoteAddr);
  end else begin
...
begin
  for I := 0 to m_ServerList.Count - 1 do begin
    ...
    if MsgServer.Socket = Socket then begin
      //MainOutMessage('MSocketClientDisconnect:' + Socket.RemoteAddress);
      Dispose(MsgServer);
      ...
      while (Pos(')', sReviceMsg) > 0) do begin
        ...
        case nCode of
          ...
          SS_SERVERINFO: begin
             ...
             { MainOutMessage('sServerName:'+sServerName);
              MainOutMessage('sIndex:'+sIndex);
              MainOutMessage('sOnlineCount:'+sOnlineCount);    }
