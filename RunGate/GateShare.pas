...
var
  ...
  g_sSpeedingMsg: string = '[提示]: 请爱护游戏环境，关闭加速外挂重新登陆';

  g_btRedMsgFColor: Byte = $FF; //前景
  g_btRedMsgBColor: Byte = $38; //背景
  g_btGreenMsgFColor: Byte = $DB; //前景
  g_btGreenMsgBColor: Byte = $FF; //背景
  g_btBlueMsgFColor: Byte = $FF; //前景
  g_btBlueMsgBColor: Byte = $FC; //背景
