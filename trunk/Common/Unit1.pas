...
var
  Form1: TForm1;
  DCP_blockcipher: array[0..22] of TDCP_blockcipher;
    ...
    case ComboBox1.ItemIndex of
      0:
        begin
          ...
          Memo2.Lines.Add(DCP_blowfish1.EncryStrHex(Memo1.Lines.Strings[i]));
          DCP_blowfish1.Reset;
        end;
      1:
        begin
      ...
      3:
        begin
          ...
          DCP_des1.Reset;
          Memo2.Lines.Add(DCP_des1.EncryStrHex(Memo1.Lines.Strings[i]));
          DCP_des1.Reset;
        end;
      4:
        begin
 ...
 { List := TList.Create;
  for I := 0 to 100 do begin
    for II := 0 to 100000 do begin
      ...
      DCP_des.InitStr('DCP_des');
      DCP_des.Reset;
      List.Add(DCP_des);
    end;
    for II := 0 to List.Count-1 do begin
      TDCP_des(List.Items[II]).Free;
    end;
    List.Clear;
  end;
  List.Free;}
    ...
    case ComboBox1.ItemIndex of
      ...
      3:
        begin
          DCP_des1.InitStr(edit3.text);
          DCP_des1.Reset;
          Dest := DCP_des1.DecryStrHex(Memo2.Lines.Strings[i]);
          DCP_des1.Reset;
...
initialization
  begin
    ...
    DCP_blowfish1 := TDCP_blowfish.Create;

    DCP_cast1281 := TDCP_cast128.Create;
    DCP_cast2561 := TDCP_cast256.Create;
    DCP_des1 := TDCP_des.Create;
    DCP_3des1 := TDCP_3des.Create;
    DCP_gost1 := TDCP_gost.Create;
    DCP_ice1 := TDCP_ice.Create;
    DCP_ice21 := TDCP_ice2.Create;

    DCP_thinice1 := TDCP_thinice.Create;
    DCP_idea1 := TDCP_idea.Create;
    DCP_mars1 := TDCP_mars.Create;
    DCP_misty11 := TDCP_misty1.Create;

    DCP_rc21 := TDCP_rc2.Create;

    DCP_rc41 := TDCP_rc4.Create;

    DCP_rc61 := TDCP_rc6.Create;
    DCP_rc51 := TDCP_rc5.Create;

    DCP_rijndael1 := TDCP_rijndael.Create;

    DCP_twofish1 := TDCP_twofish.Create;

    DCP_sha11 := TDCP_sha1.Create;

    DCP_ripemd1601 := TDCP_ripemd160.Create;

    DCP_md51 := TDCP_md5.Create;
    DCP_md41 := TDCP_md4.Create;

    DCP_haval1 := TDCP_haval.Create;
  end;
