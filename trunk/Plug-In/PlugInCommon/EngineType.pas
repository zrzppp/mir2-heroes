...
const
  ...
  RC_PLAYOBJECT = 0;
  RC_PLAYMOSTER = 150; //ÈËÐÎ¹ÖÎï
  RC_HEROOBJECT = 66; //Ó¢ÐÛ
...
{$IFEND}
  ...
  _TOBJECTACTIONITEM = function(AObject: TObject; pszItemName: PChar; boHintMsg: Boolean): Boolean; stdcall;
  ...
  _TOBJECTFILTERMSG = function(PlayObject: TObject; pszSrcMsg, pszDestMsg: PChar): Boolean; stdcall;

  _TEDCODE = procedure(pszSource: PChar; pszDest: PChar; nSrcLen, nDestLen: Integer); stdcall;
  _TDOSPELL = function(MagicManager: TMagicManager; PlayObject: TPlayObject; UserMagic: _LPTUSERMAGIC; nTargetX, nTargetY: Integer; TargeTActorObject: TActorObject; var boSpellFail, boSpellFire: Boolean): Boolean; stdcall;
